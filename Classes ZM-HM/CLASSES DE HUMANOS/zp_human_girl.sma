...
{
	register_plugin("[ZP] Class: Human Girl", "1.0", "TEIXEIRA")

	g_classegirlID = zp_register_human_class(hclass1_name, hclass1_info, hclass1_health, hclass1_armor, hclass1_speed, hclass1_gravity)
}
...
public zp_weapon_selected_post(id, wpn_type)
{
	...
	if(zp_get_next_human_class(id) != g_classegirlID || zp_get_user_zombie(id) || zp_get_human_special_class(id))
		return;
