...
#define VERSION	"1.0" // The Version For Zombie The Hero M4M3TS Version, Manual Class
...
// View Models
#define V_KNIFE_MODEL		"models/asep/v_knife_metatronic.mdl"
#define V_GRENADE_MODEL_MERAH	"models/asep/v_bomb_metatronic_merah.mdl"
#define V_GRENADE_MODEL_IJO	"models/asep/v_bomb_metatronic_ijo.mdl"
...
{	
	...
	precache_model(V_GRENADE_MODEL_MERAH)
	precache_model(V_GRENADE_MODEL_IJO)
	
	precache_model(BUFFSPR_MODEL)
	precache_model(SPR_MODEL)
	
	precache_viewmodel_sound(V_GRENADE_MODEL_MERAH)
	precache_viewmodel_sound(V_GRENADE_MODEL_IJO)
...
{
	register_native("make_metatronic", "make_metatronic", 1)
	register_native("metatronic_reset_value", "metatronic_reset_value", 1)
}
...
public Event_CurWeapon(id)
{
	...
	switch(read_data(2))
	{
		...
		case CSW_SMOKEGRENADE: set_pev(id, pev_viewmodel2, V_GRENADE_MODEL_MERAH)
		case CSW_HEGRENADE: set_pev(id, pev_viewmodel2, V_GRENADE_MODEL_IJO)
	}
